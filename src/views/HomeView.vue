<template>
  <section class="p-4 w-full">
    ...
    <p class="text-center py-2 dark:text-white font-bold">Hello, {{userStore?.user?.name || 'Guest user'}} !!</p>
    <p v-if="!userStore?.user?.id" class="text-center py-2 dark:text-white font-bold">You need to log in.</p>
    <div class="w-[320px] h-[160px] flex justify-between mx-auto gap-2 py-4 sm:w-[560px] md:w-[620px] lg:w-[720px] font-titan">
    ...
    <div class="w-[280px] flex justify-between mx-auto gap-2 py-10 sm:w-[320px] md:w-[320px] lg:w-[400px] font-titan">
      <router-link to="/task-add" class="min-w-[100px] bg-gray-600 text-white inline-block text-center rounded p-2 hover:text-orange-400">Add<i class="fa-solid fa-pen pl-1"></i></router-link>
      <button @click.prevent="handleLogout" class="min-w-[100px] bg-gray-600 text-white rounded p-2 hover:text-orange-400">logout<i class="fa-solid fa-door-closed pl-1"></i></button>
    </div>
  </section>
</template>
