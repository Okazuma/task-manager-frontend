    ...
    <section class="p-4 w-full">
        ...
        <form @submit.prevent="addTask" class="" >
            ...
            <label for="taskDetail" class="block text-center py-2">
                ...
                <textarea name="" id="taskDetail" v-model="taskContent.taskDetail" class="text-gray-800 block mx-auto rounded w-72 h-40  border-2 border-gray-300 p-2 sm:w-[400px] md:w-[500px] lg:w-[700px] sm:h-32 md:h-32 lg:h-32"></textarea>
            </label>
            ...
            <div class="flex justify-between mx-auto py-4 w-[280px] sm:w-[320px] md:w-[480px] lg:w-[560px] font-titan">
