    ...
    <section class="p-4 w-full  font-titan">
        ...
        <form @submit.prevent="handleLogin">
            ...
            <div class="flex justify-between mx-auto py-10 w-[280px] sm:w-[320px] md:w-[320px] lg:w-[400px]">
                ...
                <button type="submit" class="min-w-[100px] bg-gray-600 text-white  block text-center rounded p-2 hover:text-orange-400">Submit<i class="fa-solid fa-right-long pl-1"></i></button>
            </div>
        </form>
    </section>
</template>
